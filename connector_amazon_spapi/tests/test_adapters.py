...
class TestAmazonAdapters(common.CommonConnectorAmazonSpapi):
    ...
    def test_orders_adapter_list_orders(self):
        ...
        adapter = self.backend.component(usage="orders.adapter")
    ...
    def test_pricing_adapter_get_competitive_pricing(self):
        ...
        adapter = self.backend.component(usage="pricing.adapter")
    ...
    def test_inventory_adapter_create_inventory_feed(self):
        ...
        adapter = self.backend.component(usage="inventory.adapter")
    ...
    def test_feed_adapter_create_feed_document(self):
        ...
        adapter = self.backend.component(usage="feed.adapter")
    ...
    def test_catalog_adapter_search_catalog_items(self):
        ...
        adapter = self.backend.component(usage="catalog.adapter")
    ...
    def test_listings_adapter_get_listings_item(self):
        ...
        adapter = self.backend.component(usage="listings.adapter")
...
class TestShopAdapterIntegration(common.CommonConnectorAmazonSpapi):
    ...
    @mock.patch(
        "odoo.addons.connector_amazon_spapi.components.backend_adapter.AmazonOrdersAdapter.list_orders"
    )
...
class TestOrderAdapterIntegration(common.CommonConnectorAmazonSpapi):
    ...
    @mock.patch(
        "odoo.addons.connector_amazon_spapi.components.backend_adapter.AmazonOrdersAdapter.get_order_items"
    )
