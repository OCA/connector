    ...
    def sync_catalog(self):
        ...
        try:
            ...
            with self.backend_id.work_on("amazon.product.binding") as work:
                ...
                result = adapter.get_inventory_summary(
                    marketplace_ids=[self.marketplace_id.marketplace_id],
                    granularityId=self.marketplace_id.marketplace_id,
                    details=True,
                ...
                order_lines = self.env["amazon.sale.order.line"].search([])
                seller_skus += order_lines.mapped("seller_sku")
                seller_skus = list(set(seller_skus))
