...
def extend(class_to_extend):
    ...
    Will add the method foo to the class osv.osv
    """
    def decorator(func):
...
#    """
#    Decorator to use to overwrite a existing class with a new method
#    
#    Example : 
#    @overwrite(osv.osv)
#    def foo():
...
#      ...
#    
#    Will overwrite the method foo from the class osv.osv by this new method
#    """
#    def decorator(func):
...
class ExternalSession(object):
    ...
    def __init__(self, referential, sync_from_object):
        """init the obect ExternalSession
        :param browse_record referential: referential object
        :param browse_record sync_from_object: object that start the action
        """
